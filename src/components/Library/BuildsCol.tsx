        ...
        >
            <div className="flex flex-col gap-3.5">
                <div className="relative w-full h-16 rounded-md border flex justify-between pr-3.5 items-center border-white/25 backdrop-blur-2xl bg-black/1 overflow-hidden shadow-lg group">
                    ...
                    <div className="flex pl-1.5 mb-6 gap-2">
                    ...
                    <div className="flex gap-2.5">
                        <div className="text-white/55 p-1.75 rounded-sm border cursor-pointer border-white/25 hover:text-white/80 hover:border-white/50 transition-all duration-300 ease backdrop-blur-md">
