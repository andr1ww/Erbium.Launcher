  ...
  return (
    <motion.div
      ...
      className="
            ...
            rounded-md bg-gradient-to-br from-slate-600/8 via-black/8 to-slate-600/8 backdrop-blur-lg border border-white/25 shadow-xl
            "
    >
      <img
        src="Logo.png"
      ...
      <button
        ...
        className="
                py-3 px-4 rounded-lg border border-white/20 text-white font-semibold transition-all duration-200
                relative bg-white/10 hover:bg-white/20 backdrop-blur-md shadow-lg w-full mt-10 cursor-pointer
                "
      >
        Continue
      </button>
