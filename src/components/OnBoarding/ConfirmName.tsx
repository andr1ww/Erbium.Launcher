...
const ConfirmName: React.FC = () => {
  ...
  return (
    ...
    >
      <GlassContainer className="relative p-8 w-105 flex flex-col items-center justify-center rounded-md shadow-xl">
        <img
          src="Logo.png"
          alt="Logo"
        ...
        <div className="flex flex-col mt-8 w-full">
          <div className="flex gap-3 w-full">
            ...
            <button
              ...
              className="py-3 px-4 flex-2 rounded-lg border border-white/20 font-semibold transition-all duration-200 relative backdrop-blur-md shadow-lg w-full cursor-pointer bg-white/10 hover:bg-white/20 text-white"
            >
              Continue
            </button>
          </div>
